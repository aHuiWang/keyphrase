...
parser.add_argument('-dataset', default='kp20k', type=str,
                    help="Name of dataset")
parser.add_argument('-save_data', default='AAAI', type=str,
...
# -dataset small_kp20k -save_data small_kp20k
def main():
    '''
    ...
    if opt.dataset == 'kp20k' or opt.dataset == 'small_kp20k':
    ...
    src_trgs_pairs = pykp.io.load_json_data(opt.train_path, name=opt.dataset, src_fields=src_fields,
    ...
    fw = open(opt.save_data+'_tokenized_train_pairs.json','w')
    ...
    f = open(opt.save_data+'_tokenized_train_pairs.json', 'r')
