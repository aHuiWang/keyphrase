...
def model_opts(parser):
    ...
    # RNN Options
    parser.add_argument('-encoder_type', type=str, default='BiGRU',
                        choices=['BiGRU' ,'Attention'],
                        # choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                        help="""Type of encoder layer to use.""")
    parser.add_argument('-decoder_type', type=str, default='CopyRNN',
                        choices=['CopyRNN' ,'Memory Network'],
...
def predict_opts(parser):
    ...
    parser.add_argument('-report_file', type=str, default="",
                        help=""" Predict detail """)
